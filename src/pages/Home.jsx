        ...
        <div className="flex-1 text-center md:text-left">
          <h1 className="font-extrabold text-5xl md:text-6xl leading-tight">
            ...
            <span className="block mt-2 ">
              BOSSA Yannick <br className="hidden sm:block" /> Primaël
            </span>
          </h1>
          <h3 className="text-2xl mt-4 font-semibold">Développeur Web</h3>
          <p className="mt-6 text-lg max-w-lg">
            Je crée des sites modernes, performants et adaptés à vos besoins.
          </p>
          ...
          <div className="mt-4">
            ...
            <a
              ...
              className="btn shadow-xl hover:shadow-primary/40 border-2 border-primary"
            >
              <svg
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="btn shadow-xl hover:shadow-primary/40 border-2 border-primary ml-2"
            >
              <svg
